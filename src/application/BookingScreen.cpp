...
void BookingScreen::render() {
    ...
    Schedule _newSchedule = schedules.elementAt(scheduleIndex);
    Schedule* newSchedule = new Schedule();
    newSchedule->setBus(_newSchedule.getBus());
    newSchedule->setDepartureDate(_newSchedule.getDepartureDate());
    newSchedule->setFrom(_newSchedule.getFrom());
    newSchedule->setId(_newSchedule.getId());
    newSchedule->setInbound(_newSchedule.getInbound());
    newSchedule->setOutbound(_newSchedule.getOutbound());
    newSchedule->setPrice(_newSchedule.getPrice());
    newSchedule->setReturnDate(_newSchedule.getReturnDate());
    newSchedule->setStopovers(_newSchedule.getStopovers());
    newSchedule->setTo(_newSchedule.getTo());
